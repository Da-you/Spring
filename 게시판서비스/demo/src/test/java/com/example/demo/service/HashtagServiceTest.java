...
@InjectMocks
    ...
    void giveContent_whenParsing_thenReturnUniqueHashtagNames(String input, Set<String> expected) {
        // given
        // when
    ...
    static Stream<Arguments> giveContent_whenParsing_thenReturnUniqueHashtagNames() {
        return Stream.of(
