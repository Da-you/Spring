...
public class BasicTxTest {
  ...
  void double_commit() {
    ...
    log.info("트랜잭션2 시작");
    TransactionStatus tx2 = txManager.getTransaction(new DefaultTransactionAttribute()); log.info("트랜잭션2 커밋"); txManager.commit(tx2);
  }
  @Test
  ...
  void inner_commit() {
    ...
    // Participating in existing transaction 라는 문구 출력됨 이 메시지는 내부 트랜잭션이 기존에 존재하는 외부 트랜잭션에 참여한다는 뜻이다.
